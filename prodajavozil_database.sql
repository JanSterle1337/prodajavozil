...
(5, 'Iste shit je po pravic povejdanu. Enu je od nemca, drugu pa od kitajca.', 3, 10, '2022-02-01 23:03:25'),
(6, 'Men se zdi da najbulš izbira je VW GOLF 8.', 18, 5, '2022-02-02 12:59:16'),
(7, 'Neki neki', 18, 5, '2022-02-02 13:41:24'),
...
(24, 'Helouuu', 3, 6, '2022-02-22 10:41:30'),
(25, 'Men se zdi da je podpadc najači profesor.', 18, 5, '2022-03-07 20:44:36'),
(26, 'Ojjjjjj.', 18, 5, '2022-04-09 14:07:45');
...
(68, 'Neki neki2', '2022-03-11 08:55:02', 1, 7, 3, NULL),
...
(22, 'Dobro ohranjeno vozilo. Lp', 18000, 'neprodano', '2022-01-28 21:48:35', '2022-03-08 23:00:00', 31, 'A3', 'Audi', 3),
...
(34, 'Kar ok ohranjenu. Za ceno se da še dogovorit..', 23500, 'neprodano', '2022-04-11 15:31:27', '2022-03-08 23:00:00', 43, 'A5', 'Audi', 3),
(35, 'Odličen, prebarvan na rdečo.', 35000, 'neprodano', '2022-04-13 18:50:28', '2022-03-08 23:00:00', 44, 'Golf', 'Volkswagen', 3),
(36, 'Mau ga rja načenja, zamenjan motor, potrebno popravilo zavor.', 2300, 'neprodano', '2022-02-26 12:02:01', '2022-03-08 23:00:00', 45, 'serija 3', 'Volkswagen', 3),
...
(39, 'Kot nov. Vse dela brez problemov.', 39500, 'neprodano', '2022-02-26 17:30:19', '2022-03-08 23:00:00', 48, 'serija 5', 'Volkswagen', 18),
...
--
-- Dumping data for table `oglas_karantena`
--

INSERT INTO `oglas_karantena` (`karantena_oglasID`, `created_at`, `status`) VALUES
(45, '2022-04-13', 'Oglas je odstranjen');
...
(51, 'og26voz35up3num0.jpg', '2022-01-28 22:50:26', 26, 35, 'Arteon', 'Volkswagen', 3),
(52, 'og26voz35up3num1.jpg', '2022-01-28 22:50:26', 26, 35, 'Arteon', 'Volkswagen', 3),
(53, 'og26voz35up3num2.jpg', '2022-01-28 22:50:26', 26, 35, 'Arteon', 'Volkswagen', 3),
...
(75, 'og35voz44up3num0.jpg', '2022-02-26 11:39:44', 35, 44, 'Golf', 'Volkswagen', 3),
(76, 'og35voz44up3num1.jpg', '2022-02-26 11:39:44', 35, 44, 'Golf', 'Volkswagen', 3),
(77, 'og22voz31up3num1.jpg', '2022-02-26 11:54:43', 22, 31, 'A3', 'Audi', 3),
(78, 'og36voz45up3num0.jpg', '2022-02-26 12:02:01', 36, 45, 'Arteon', 'Volkswagen', 3),
(79, 'og36voz45up3num1.jpg', '2022-02-26 12:02:01', 36, 45, 'Arteon', 'Volkswagen', 3),
...
(85, 'og39voz48up18num0.jpg', '2022-02-26 15:59:53', 39, 48, 'serija 5', 'Volkswagen', 18),
(86, 'og39voz48up18num1.jpg', '2022-02-26 15:59:53', 39, 48, 'serija 5', 'Volkswagen', 18),
...
(90, 'og42voz51up18num0.jpg', '2022-04-08 19:08:37', 42, 51, 'Golf', 'Volkswagen', 18),
(91, 'og44voz53up3num0.jpg', '2022-04-08 19:14:37', 44, 53, 'Arteon', 'Volkswagen', 3),
(92, 'og44voz53up3num1.jpg', '2022-04-08 19:14:37', 44, 53, 'Arteon', 'Volkswagen', 3),
...
(5, 'Kateri avto priporočate v letu 2022?', 'Men se to zdi odpadna pločevina. Skratka ena velka pločevina.', 3, '2022-02-01 20:54:04'),
...
(3, 'Jan', 'Sterle', 'eva.sterle123@gmail.com', '$2y$10$3vUTNFnR90GHwnJJXYAOl.bJQbdj3oXgBB1ErdU.FZ7.xl0J0bPGq', '070766355', 'Sem najbolši prodajalec iz Lwške doline. Moje avte je blagoslovil Sv. Peter. Sem najbolši. LP', '2022-01-08 18:30:24'),
...
(43, 'ljrf4332543nrfe12', 144000, 2017, 'bencin', 'Audi', 'A5', '2022-04-11 15:31:27'),
(44, 'jjkneki2435sah99h', 12563, 2015, 'hibrid', 'Volkswagen', 'Golf', '2022-04-13 18:50:28'),
(45, '462ngtrtr2saggga2', 456444, 2005, 'diesel', 'BMW', 'serija 3', '2022-02-26 12:02:01'),
...
(48, 'JKKK32AV34BZZ', 12333, 2021, 'hibrid', 'BMW', 'serija 5', '2022-02-26 17:30:19'),
...
--
ALTER TABLE `odgovor`
  MODIFY `odgovorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;

--
-- AUTO_INCREMENT for table `oglas`
--
ALTER TABLE `oglas`
  MODIFY `oglasID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT for table `profilka`
--
ALTER TABLE `profilka`
  MODIFY `profilkaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `slika`
--
ALTER TABLE `slika`
  MODIFY `slikaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;

--
-- AUTO_INCREMENT for table `sporočilo`
--
ALTER TABLE `sporočilo`
  MODIFY `sporočiloID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `uporabnik`
  MODIFY `uporabnikID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `vozilo`
--
ALTER TABLE `vozilo`
  MODIFY `voziloID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
